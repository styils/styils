...
export const { styled, SystemProvider, createExtracts, createGlobal, useSystem, flush, keyframes } =
  createSystem({
    ...
    defaultMode: import.meta.env.SSR
      ? 'light'
      : localStorage.getItem('styils-theme-mode') ?? 'light'
  })
